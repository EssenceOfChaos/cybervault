defmodule CybervaultWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CybervaultWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CybervaultWeb.Gettext, "errors", msg, opts)
    end
  end
